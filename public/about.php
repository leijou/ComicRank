...
<section class="sectionbox">
    ...
    <div class="contentwrap">
        <p>Comic Rank started in 2008 as a free Webcomic leaderboard and reader tracker. The service was ad supported but as we rose in fame server costs mounted and moderation of the public leaderboards became unmanageable.</p>
...
<section class="sectionbox">
    ...
    <footer>
        <p>Have your own suggestions or want to help out? <a href="/contact.php">let me know</a>.</p>
    </footer>
</section>
